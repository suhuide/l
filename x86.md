- [1 Linux/Ubuntu 启动流程](#1-linuxubuntu-启动流程)
- [2 Ubuntu 20.04 ISO](#2-ubuntu-2004-iso)
  - [2.1 基本信息](#21-基本信息)
  - [2.2 根目录结构(挂载 ISO 后)](#22-根目录结构挂载-iso-后)
    - [2.2.1 引导部分](#221-引导部分)
    - [2.2.2 文件系统](#222-文件系统)
    - [2.2.3 ISO目录结构](#223-iso目录结构)
    - [2.2.4 squashfs文件](#224-squashfs文件)
    - [2.2.5 引导配置](#225-引导配置)
    - [2.2.6 内核和initrd](#226-内核和initrd)
    - [2.2.7 UEFI和BIOS兼容性](#227-uefi和bios兼容性)
    - [2.2.9 安装程序](#229-安装程序)
    - [2.2.10 软件包仓库](#2210-软件包仓库)
    - [2.2.11 校验和签名](#2211-校验和签名)
- [3 ISO的制作](#3-iso的制作)
  - [自动生成脚本](#自动生成脚本)
  - [开发环境/Dependencies](#开发环境dependencies)
  - [内核/Kernel](#内核kernel)
  - [初始文件系统/initramfs](#初始文件系统initramfs)
  - [根文件系统/rootfs](#根文件系统rootfs)
  - [引导/GRUB](#引导grub)
  - [生成/Generate](#生成generate)
- [4 基于x86 Atom x6425E 的 ISO](#4-基于x86-atom-x6425e-的-iso)
  - [4.1 开发环境准备](#41-开发环境准备)
    - [系统要求与依赖安装](#系统要求与依赖安装)
    - [ISO制作依赖](#iso制作依赖)
  - [4.2 内核获取与编译](#42-内核获取与编译)
    - [下载内核源码](#下载内核源码)
    - [配置内核](#配置内核)
    - [编译内核](#编译内核)
    - [生成的deb](#生成的deb)
  - [4.3 用cubic制作新ISO](#43-用cubic制作新iso)
...
### 2.2.3 [ISO目录结构](./files/x86/iso-folder.png)

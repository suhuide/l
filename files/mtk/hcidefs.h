 ...
 *
 ******************************************************************************/
// /sel/alps/vendor/mediatek/proprietary/packages/modules/Bluetooth/system/stack/include/hcidefs.h
#ifndef HCIDEFS_H
#define HCIDEFS_H
...
/*M: HDT opcode */
#define HCI_HDT_CMD (0x005B | HCI_GRP_VENDOR_SPECIFIC)

/* SOC Logging OCF */
#define HCI_VS_HOST_LOG_OPCODE (0x0017 | HCI_GRP_VENDOR_SPECIFIC)

/*M: Read chip type*/
#define HCI_DUAL_A2DP_CHIP_OPCODE_OCF (0x019D | HCI_GRP_VENDOR_SPECIFIC)
...
/* Bluetooth sbc 2M&3M adujst packet length Report sub event */
#define HCI_VSE_SUBCODE_SBC_ADJUST_PACKET_LEN_EVT 0x75

/* Bluetooth ldac abr scenario evt Report sub event */
#define HCI_VSE_SUBCODE_LDAC_ABR_EVT 0x76

/* MTK add for firmware error report */
#define HCI_MTK_FIRMWARE_MONITOR_FEATURE_PARAM_SIZE 1
#define HCI_MTK_FIRMWARE_MONITOR_FEATURE (0x0166 | HCI_GRP_VENDOR_SPECIFIC)

#define HCI_MTK_FIRMWARE_MONITOR_FEATURE_ENABLE 0X01
#define HCI_MTK_FIRMWARE_MONITOR_FEATURE_DISABLE 0X00
...
#define HCI_ENCRYPTION_CHANGE_V2_EVT 0x59

/** M: For HDT */
#define HCI_HDT_EVT 0xE9
#define HCI_READ_RMT_HDT_FEATURES_COMP_EVT 0x01
#define HCI_DATA_RATE_CHANGE_EVT 0x02
#define HCI_READ_RMT_HDT_LE_FEATURES_COMP_EVT 0x04
/** @} */
...
#define HCI_FW_MONITOR_HANDLE 0x0EFD
...
#define HCI_EDR4_DH5_PACKET_SIZE 1392
#define HCI_EDR6_DH5_PACKET_SIZE 2089
#define HCI_EDR8_DH5_PACKET_SIZE 2820
